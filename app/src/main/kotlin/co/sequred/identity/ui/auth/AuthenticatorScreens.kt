package co.sequred.identity.ui.auth
...
import co.sequred.identity.data.AuthenticatorEntry
...
private fun copy(ctx: Context, text: String) {
    co.sequred.identity.data.ClipboardGuard.copySensitive(ctx, "totp", text)
}
